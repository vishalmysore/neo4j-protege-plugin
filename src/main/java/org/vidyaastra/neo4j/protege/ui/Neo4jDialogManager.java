...
/**
 * Centralized dialog management for Neo4j plugin UI interactions.
 */
public class Neo4jDialogManager {
    ...
    public void showWarningMessageDialog(Component parent, String message) {
